import "./Purpose.css";
import BulletPointIcon from "../../../assets/icons/icon-bullet-point.svg";

const Purpose = () => {
  return (
    <section className="purpose">
      <h2 className="text-preset-2 purpose__title">Why we exist</h2>
      <ul className="purpose__list">
        <li className="purpose__item">
          <h3 className="text-preset-4">Cut through the noise.</h3>
        ...
        <li className="purpose__item">
          <h3 className="text-preset-4">Empower home kitchens.</h3>
        ...
        <li className="purpose__item">
          <h3 className="text-preset-4">Make healthy look good.</h3>
